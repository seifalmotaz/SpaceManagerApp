  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => InkWell(
        ...
        child: Opacity(
          opacity: index != controller.$AppointmentGroup_ ? .51 : 1,
          child: IgnorePointer(
            ignoring: index != controller.$AppointmentGroup_,
            child: Container(
              color: colorWhite,
                    ...
                    children: [
                      Flexible(
                        child: WTextField(
                          ...
                          onChange: (string) => controller
                              .setReservationGroupTitle(index, string),
                        ),
                      ),
                      IconButton(
                    ...
                    itemBuilder: (context, i) {
                      return Obx(
                        () => InkWell(
                          ...
                          child: Opacity(
                            opacity:
                                i != controller.$AppointmentSubGroup_ ? .51 : 1,
                            child: IgnorePointer(
                              ...
                              child: MiniTimeChipWidget(
                                ...
                                onDelete: () {
                                  ...
                                  controller.appointmentGroups.update(index,
                                      (value) {
                                  ...
                                  if (_subgroupsLength == 0) {
                                    Map<int, AppointmentGroup> _groups = Map.of(
